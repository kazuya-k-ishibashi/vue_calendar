(function () {
  ...
  var range = function(
      ...
      var arr = [];
      for (var i = begin; i <= end; i += _interval) {
          arr.push(i);
      }
      return arr
  };
  ...
  var createWeekListOfMonth = function(
      ...
      var _startDayOfMonth = (dateOrYear instanceof Date)
              ? start_of_month(dateOrYear)
              : new Date(dateOrYear, month, 1);
      var startDayOfStartWeekOfMonth = start_of_week(_startDayOfMonth);

      var _lastDayOfMonth = last_day_of_month(_startDayOfMonth);
      var lastDayOfLastWeekOfMonth = last_day_of_week(_lastDayOfMonth);

      var dateOfWeekList = [];
      for (var date = startDayOfStartWeekOfMonth;
              is_before(date, add_days(lastDayOfLastWeekOfMonth, 1));
              date = add_days(date, 1)) {

          dateOfWeekList.push(date);
          if (is_same_day(date, last_day_of_week(date))) {
  ...
  (function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css=".header[data-v-38cab9c1] { display: flex; width: 21em; } .header .prev-month[data-v-38cab9c1], .header .next-month[data-v-38cab9c1] { width: 5.25em; } .header .change-prev-month-button[data-v-38cab9c1], .header .change-next-month-button[data-v-38cab9c1] { width: 3em; margin: auto; } .header .calendar-year-and-month[data-v-38cab9c1] { width: 10.5em; } .header .calendar-year-and-month>span[data-v-38cab9c1] { margin: auto; } .day[data-v-38cab9c1], .date[data-v-38cab9c1] { width: 3em; height: 3em; } .day.sunday[data-v-38cab9c1], .date.sunday[data-v-38cab9c1] { color: #f00; } .day.saturday[data-v-38cab9c1], .date.saturday[data-v-38cab9c1] { color: #00f; } .date.not-this-month[data-v-38cab9c1] { color: #c0c0c0; } .week-header[data-v-38cab9c1], .week[data-v-38cab9c1] { display: flex; } "; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();
  ...
  var className = {
      isThisMonth: function isThisMonth(
          ...
          return is_same_month(date, calendarDate)
                  ? "this-month"
                  : "not-this-month"
      },
      weekday: function weekday(date /* :Date */) {
          return Object.getOwnPropertyNames(Weekday)
                  .map(function (key) { return Weekday[key]; })
                  .find(function (day) { return day.id === date.getDay(); })
                  .en
      }
  };

  var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"component-root"},[_c('div',{staticClass:"header"},[_c('div',{staticClass:"prev-month"},[_c('button',{staticClass:"change-prev-month-button",attrs:{"title":_vm.formatYearAndMonth(_vm.prevMonth)},on:{"click":_vm.subMonth}},[_vm._v("＜")])]),_c('div',{staticClass:"calendar-year-and-month"},[_c('span',[_c('select',{staticClass:"calendar-year",on:{"change":_vm.changeYear}},_vm._l((_vm.calendarYearOptions),function(year){return _c('option',{domProps:{"value":year,"selected":year === _vm.calendarYear}},[_vm._v(_vm._s(year))])})),_c('span',[_vm._v("年")]),_c('select',{staticClass:"calendar-month",on:{"change":_vm.changeMonth}},_vm._l((_vm.calendarMonthOptions),function(month){return _c('option',{domProps:{"value":month,"selected":month === _vm.calendarMonth}},[_vm._v(_vm._s(month + 1))])})),_c('span',[_vm._v("月")])])]),_c('div',{staticClass:"next-month"},[_c('button',{staticClass:"change-next-month-button",attrs:{"title":_vm.formatYearAndMonth(_vm.nextMonth)},on:{"click":_vm.addMonth}},[_vm._v("＞")])])]),_c('div',{staticClass:"body"},[_c('div',{staticClass:"week-header"},_vm._l((_vm.Weekday),function(day){return _c('div',{staticClass:"day",class:day.en},[_c('span',[_vm._v(_vm._s(day.ja))])])})),_vm._l((_vm.weekList),function(week){return _c('div',{staticClass:"week"},_vm._l((week),function(date){return _c('div',{staticClass:"date",class:[_vm.className.weekday(date), _vm.className.isThisMonth(date, _vm.calendarDate)]},[_c('span',[_vm._v(_vm._s(date.getDate()))])])}))})],2)])},staticRenderFns: [],_scopeId: 'data-v-38cab9c1',
      data: function data() {
          return {
              Weekday: Weekday,
              className: className
      ...
      computed: Object.assign({
          calendarYearOptions: function calendarYearOptions() {
              var year = this.calendarYear;
              return range(year - 5, year + 5)
          },
          calendarMonthOptions: function calendarMonthOptions() {
              return range(0, 11)
          }
      },
      mapState([
      ...
      methods: Object.assign({
          formatYearAndMonth: function formatYearAndMonth(
                  dateOrYear  /* :Date      | number */,
                  month       /* :undefined | number */) /* :string */ {
              var date = (dateOrYear instanceof Date)
                      ? dateOrYear
                      : new Date(dateOrYear, month, 1);
              return format_1(date, "YYYY年M月")
          },
  ...
  var getters = {
      calendarDate : function (state) { return state.calendarDate; },
      calendarYear : function (state) { return state.calendarDate.getFullYear(); },
      calendarMonth: function (state) { return state.calendarDate.getMonth(); },
      prevMonth    : function (state) { return sub_months(state.calendarDate, 1); },
      nextMonth    : function (state) { return add_months(state.calendarDate, 1); },
      weekList     : function (state) { return createWeekListOfMonth(state.calendarDate); }
  };

  var mutations = {
      updateCalendarDate: function updateCalendarDate(state, payload /* Object */) {
          var year = payload.year;
          var month = payload.month;
          var calendarDate = payload.calendarDate;
  ...
  var actions = {
      subMonth: function subMonth(ref) {
          var commit = ref.commit;
      ...
      addMonth: function addMonth(ref) {
          var commit = ref.commit;
      ...
      changeYear: function changeYear(ref, year) {
          var commit = ref.commit;

          commit("updateCalendarDate", { year: year });
      },
      changeMonth: function changeMonth(ref, month) {
          var commit = ref.commit;

          commit("updateCalendarDate", { month: month });
      }
  };
  ...
  var isDebugging = "development" !== 'production';

  Vue.use(index_esm);

  var store = new index_esm.Store(Object.assign({
      strict: isDebugging
  }, calendar))
